...
CREATE TABLE IF NOT EXISTS public.boss_action_items (
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_agent_runs (
...
CREATE TABLE IF NOT EXISTS public.boss_audit (
    id bigint NOT NULL,
    actor text,
    action text,
    target text,
...
CREATE TABLE IF NOT EXISTS public.boss_budget (
    id integer NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_crm_contacts (
    id text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_crm_opportunities (
    id text NOT NULL,
    tenant_id text DEFAULT 'default'::text,
    name text,
    pipeline_id text,
...
CREATE TABLE IF NOT EXISTS public.boss_crm_snapshot (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text,
...
CREATE TABLE IF NOT EXISTS public.boss_email_drafts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_email_log (
...
CREATE TABLE IF NOT EXISTS public.boss_expenses (
    id integer NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    vendor text,
    amount_cents bigint,
...
CREATE TABLE IF NOT EXISTS public.boss_faq (
    id integer NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_fb_messages (
    id bigint NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_fb_threads (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    conversation_id text NOT NULL,
    platform text DEFAULT 'messenger'::text NOT NULL,
    participant_id text,
...
CREATE TABLE IF NOT EXISTS public.boss_finance_snapshot (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text,
    snapshot jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now()
...
CREATE TABLE IF NOT EXISTS public.boss_google_registry (
    api text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_google_usage (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    api text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_incidents (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    kind text NOT NULL,
    source text,
...
CREATE TABLE IF NOT EXISTS public.boss_knowledge (
    id bigint NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_linkedin_posts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    text text NOT NULL,
    link text,
...
CREATE TABLE IF NOT EXISTS public.boss_memory (
    id bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_meta_credentials (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    app_id text,
    app_secret_enc text,
...
CREATE TABLE IF NOT EXISTS public.boss_meta_events (
    id bigint NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    object text,
    event_type text,
...
CREATE TABLE IF NOT EXISTS public.boss_oauth_state (
    state text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_oauth_tokens (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_onboarding (
    tenant_id text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_persistent_agents (
...
CREATE TABLE IF NOT EXISTS public.boss_pipelines (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    name text NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.boss_playbooks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    kind text NOT NULL,
    match_key text,
    title text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_rascals (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    handle text NOT NULL,
    display_name text NOT NULL,
    cli text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_reviews_snapshot (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_self_state (
...
CREATE TABLE IF NOT EXISTS public.boss_slack_messages (
    id bigint NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_stage_log (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_task_frequency (
    domain text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_telegram_pairs (
...
CREATE TABLE IF NOT EXISTS public.boss_tenants (
    id text NOT NULL,
    name text NOT NULL,
    business_name text,
...
CREATE TABLE IF NOT EXISTS public.boss_users (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text NOT NULL,
    email text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_vault (
    id integer NOT NULL,
    category text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_voice_transcripts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    conversation_id text NOT NULL,
    user_id text DEFAULT 'anonymous'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_contacts (
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_drafts (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_messages (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    chat_id text NOT NULL,
    wa_message_id text,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_monitors (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    chat_id text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_scheduled (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
    chat_id text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.boss_whatsapp_threads (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    chat_id text NOT NULL,
    display_name text,
    phone text,
...
CREATE TABLE IF NOT EXISTS public.cached_contacts (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cached_files (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
    account_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cached_tasks (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
    account_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.cleanup_proposals (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.file_rules (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    tenant_id uuid NOT NULL,
    user_id uuid,
    name character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.newsroom_tips (
    id integer NOT NULL,
    source text NOT NULL,
    sender text,
    subject text,
...
CREATE TABLE IF NOT EXISTS public.platform_manager (
    handle text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.slack_agent_grants (
    tenant_id text DEFAULT 'default'::text NOT NULL,
    agent_handle text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.slack_attention (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id text DEFAULT 'default'::text NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_action_items_owner ON public.boss_action_items USING btree (owner_rascal, status, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_backup_log_expires ON public.backup_log USING btree (expires_at) WHERE (expires_at IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_backup_log_started ON public.backup_log USING btree (started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_backup_log_status ON public.backup_log USING btree (status, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_backup_log_tenant_id ON public.backup_log USING btree (tenant_id) WHERE (tenant_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_behavioral_patterns_confidence ON public.behavioral_patterns USING btree (confidence DESC);
...
CREATE INDEX IF NOT EXISTS idx_behavioral_patterns_tenant_id ON public.behavioral_patterns USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_behavioral_patterns_type ON public.behavioral_patterns USING btree (tenant_id, pattern_type);
...
CREATE INDEX IF NOT EXISTS idx_behavioral_patterns_user_id ON public.behavioral_patterns USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_boss_agent_runs_agent ON public.boss_agent_runs USING btree (agent_id, finished_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_crm_snapshot_created ON public.boss_crm_snapshot USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_finance_snapshot_created ON public.boss_finance_snapshot USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_google_usage_api ON public.boss_google_usage USING btree (api, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_incidents_status ON public.boss_incidents USING btree (status, opened_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_memory_conf ON public.boss_memory USING btree (confidence DESC, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_boss_playbooks_match ON public.boss_playbooks USING btree (kind, match_key);
...
CREATE INDEX IF NOT EXISTS idx_brain_config_active ON public.brain_config USING btree (tenant_id, is_active) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_brain_config_primary ON public.brain_config USING btree (tenant_id) WHERE (is_primary = true);
...
CREATE INDEX IF NOT EXISTS idx_brain_config_tenant_id ON public.brain_config USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_cached_contacts_email ON public.cached_contacts USING btree (tenant_id, email) WHERE (email IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_cached_contacts_name ON public.cached_contacts USING btree (tenant_id, name);
...
CREATE INDEX IF NOT EXISTS idx_cached_contacts_synced ON public.cached_contacts USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_contacts_tenant ON public.cached_contacts USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_cached_contacts_tenant_account ON public.cached_contacts USING btree (tenant_id, account_id);
...
CREATE INDEX IF NOT EXISTS idx_cached_emails_synced ON public.cached_emails USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_emails_tenant_account ON public.cached_emails USING btree (tenant_id, account_id, date DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_emails_tenant_date ON public.cached_emails USING btree (tenant_id, date DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_emails_unread ON public.cached_emails USING btree (tenant_id, account_id, date DESC) WHERE (is_read = false);
...
CREATE INDEX IF NOT EXISTS idx_cached_events_synced ON public.cached_events USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_events_tenant_account_start ON public.cached_events USING btree (tenant_id, account_id, start);
...
CREATE INDEX IF NOT EXISTS idx_cached_events_tenant_start ON public.cached_events USING btree (tenant_id, start);
...
CREATE INDEX IF NOT EXISTS idx_cached_files_name ON public.cached_files USING btree (tenant_id, name);
...
CREATE INDEX IF NOT EXISTS idx_cached_files_synced ON public.cached_files USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_files_tenant_account ON public.cached_files USING btree (tenant_id, account_id, modified DESC NULLS LAST);
...
CREATE INDEX IF NOT EXISTS idx_cached_files_tenant_modified ON public.cached_files USING btree (tenant_id, modified DESC NULLS LAST);
...
CREATE INDEX IF NOT EXISTS idx_cached_tasks_pending ON public.cached_tasks USING btree (tenant_id, account_id, due) WHERE (status <> 'completed'::text);
...
CREATE INDEX IF NOT EXISTS idx_cached_tasks_synced ON public.cached_tasks USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cached_tasks_tenant_account ON public.cached_tasks USING btree (tenant_id, account_id, due);
...
CREATE INDEX IF NOT EXISTS idx_cached_tasks_tenant_due ON public.cached_tasks USING btree (tenant_id, due);
...
CREATE INDEX IF NOT EXISTS idx_chat_messages_session ON public.boss_chat_messages USING btree (session_id, created_at);
...
CREATE INDEX IF NOT EXISTS idx_chat_sessions_agent ON public.boss_chat_sessions USING btree (tenant_id, agent_kind, rascal_handle, updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_chat_sessions_coo ON public.boss_chat_sessions USING btree (tenant_id, agent_kind, updated_at DESC) WHERE (agent_kind = 'coo'::text);
...
CREATE INDEX IF NOT EXISTS idx_chat_sessions_gio ON public.boss_chat_sessions USING btree (tenant_id, agent_kind, updated_at DESC) WHERE (agent_kind = 'gio'::text);
...
CREATE INDEX IF NOT EXISTS idx_cleanup_proposals_batch ON public.cleanup_proposals USING btree (batch_id) WHERE (batch_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_cleanup_proposals_pending ON public.cleanup_proposals USING btree (user_id, created_at DESC) WHERE ((status)::text = 'pending'::text);
...
CREATE INDEX IF NOT EXISTS idx_cleanup_proposals_status ON public.cleanup_proposals USING btree (tenant_id, status, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_cleanup_proposals_tenant_id ON public.cleanup_proposals USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_cleanup_proposals_user_id ON public.cleanup_proposals USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_connected_accounts_active ON public.connected_accounts USING btree (tenant_id) WHERE (disconnected_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_connected_accounts_provider ON public.connected_accounts USING btree (tenant_id, provider);
...
CREATE INDEX IF NOT EXISTS idx_connected_accounts_tenant_id ON public.connected_accounts USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_email_drafts_created ON public.boss_email_drafts USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_email_log_attention ON public.boss_email_log USING btree (needs_attention, processed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_email_log_category ON public.boss_email_log USING btree (category);
...
CREATE INDEX IF NOT EXISTS idx_event_rules_tenant_id ON public.event_rules USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_event_rules_type_active ON public.event_rules USING btree (tenant_id, event_type, priority) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_event_rules_user_id ON public.event_rules USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_events_created ON public.events USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_events_tenant_id ON public.events USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_events_type ON public.events USING btree (tenant_id, event_type, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_events_unprocessed ON public.events USING btree (tenant_id, created_at) WHERE (processed = false);
...
CREATE INDEX IF NOT EXISTS idx_events_user_id ON public.events USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_file_rules_active ON public.file_rules USING btree (tenant_id, provider, priority) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_file_rules_tenant_id ON public.file_rules USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_file_rules_user_id ON public.file_rules USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_health_checks_checked_at ON public.health_checks USING btree (checked_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_health_checks_status ON public.health_checks USING btree (status, checked_at DESC) WHERE ((status)::text <> 'healthy'::text);
...
CREATE INDEX IF NOT EXISTS idx_health_checks_tenant_service ON public.health_checks USING btree (tenant_id, service, checked_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_incidents_created ON public.incidents USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_incidents_escalated ON public.incidents USING btree (escalated, created_at DESC) WHERE (escalated = true);
...
CREATE INDEX IF NOT EXISTS idx_incidents_service ON public.incidents USING btree (service, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_incidents_status ON public.incidents USING btree (status) WHERE ((status)::text <> 'resolved'::text);
...
CREATE INDEX IF NOT EXISTS idx_incidents_tenant_id ON public.incidents USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_invites_status ON public.invites USING btree (status);
...
CREATE INDEX IF NOT EXISTS idx_knowledge_domain ON public.boss_knowledge USING btree (domain, updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_learning_profiles_tenant_id ON public.learning_profiles USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_learning_profiles_user_id ON public.learning_profiles USING btree (user_id);
...
CREATE INDEX IF NOT EXISTS idx_meta_events_created ON public.boss_meta_events USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_newsroom_tips_created ON public.newsroom_tips USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_newsroom_tips_unused ON public.newsroom_tips USING btree (used_at) WHERE (used_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_oauth_tokens_account_id ON public.boss_oauth_tokens USING btree (account_id);
...
CREATE INDEX IF NOT EXISTS idx_oauth_tokens_expires ON public.oauth_tokens USING btree (expires_at) WHERE ((status)::text = 'active'::text);
...
CREATE INDEX IF NOT EXISTS idx_oauth_tokens_provider ON public.oauth_tokens USING btree (tenant_id, provider);
...
CREATE INDEX IF NOT EXISTS idx_oauth_tokens_provider_email ON public.boss_oauth_tokens USING btree (provider, email);
...
CREATE INDEX IF NOT EXISTS idx_onboarding_incomplete ON public.boss_onboarding USING btree (tenant_id, last_activity_at) WHERE (completed_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_onboarding_progress_status ON public.onboarding_progress USING btree (tenant_id, status);
...
CREATE INDEX IF NOT EXISTS idx_onboarding_progress_tenant_id ON public.onboarding_progress USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_playbooks_active ON public.playbooks USING btree (service, is_active) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_playbooks_global ON public.playbooks USING btree (service) WHERE (tenant_id IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_playbooks_service ON public.playbooks USING btree (service);
...
CREATE INDEX IF NOT EXISTS idx_playbooks_signature_fts ON public.playbooks USING gin (to_tsvector('english'::regconfig, failure_signature));
...
CREATE INDEX IF NOT EXISTS idx_playbooks_tenant_id ON public.playbooks USING btree (tenant_id) WHERE (tenant_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_preferences_category ON public.preferences USING btree (tenant_id, category) WHERE (is_active = true);
...
CREATE INDEX IF NOT EXISTS idx_preferences_source ON public.preferences USING btree (source, tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_preferences_tenant_id ON public.preferences USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_preferences_user_id ON public.preferences USING btree (user_id) WHERE (user_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_sessions_user ON public.boss_sessions USING btree (user_id, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_slack_attention_open ON public.slack_attention USING btree (tenant_id, created_at DESC) WHERE (status = 'open'::text);
...
CREATE INDEX IF NOT EXISTS idx_slack_messages_channel ON public.boss_slack_messages USING btree (channel_id, posted_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_slack_messages_sale ON public.boss_slack_messages USING btree (is_sale, posted_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_sync_state_due ON public.sync_state USING btree (tenant_id, next_sync NULLS FIRST) WHERE (status = ANY (ARRAY['idle'::text, 'never'::text, 'error'::text]));
...
CREATE INDEX IF NOT EXISTS idx_sync_state_tenant ON public.sync_state USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_tenants_email ON public.boss_tenants USING btree (primary_email);
...
CREATE INDEX IF NOT EXISTS idx_token_ledger_agent ON public.token_ledger USING btree (agent_kind, agent_handle, ts DESC);
...
CREATE INDEX IF NOT EXISTS idx_token_ledger_provider ON public.token_ledger USING btree (provider, model, ts DESC);
...
CREATE INDEX IF NOT EXISTS idx_token_ledger_ts ON public.token_ledger USING btree (ts DESC);
...
CREATE INDEX IF NOT EXISTS idx_users_active ON public.boss_users USING btree (tenant_id, active) WHERE (active = true);
...
CREATE INDEX IF NOT EXISTS idx_users_tenant ON public.boss_users USING btree (tenant_id, email);
...
CREATE INDEX IF NOT EXISTS idx_users_tenant_role ON public.users USING btree (tenant_id, role);
...
CREATE INDEX IF NOT EXISTS idx_vasari_outsiders_enabled ON public.boss_outsiders USING btree (tenant_id, enabled) WHERE (enabled = true);
...
CREATE INDEX IF NOT EXISTS idx_vasari_pipelines_tenant ON public.boss_pipelines USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_vasari_rascals_enabled ON public.boss_rascals USING btree (tenant_id, enabled) WHERE (enabled = true);
...
CREATE INDEX IF NOT EXISTS idx_vasari_stage_log_agent ON public.boss_stage_log USING btree (tenant_id, agent, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_vasari_stage_log_task ON public.boss_stage_log USING btree (task_id, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_agent ON public.boss_tasks USING btree (tenant_id, assigned_agent) WHERE (status = ANY (ARRAY['pending'::text, 'active'::text, 'blocked'::text]));
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_archived ON public.boss_tasks USING btree (tenant_id, archived_at) WHERE (archived_at IS NULL);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_client ON public.boss_tasks USING btree (tenant_id, assigned_client);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_pending_review ON public.boss_tasks USING btree (tenant_id, updated_at) WHERE ((view_column = 'to_close'::text) AND (archived_at IS NULL) AND (kind = 'task'::text));
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_response ON public.boss_tasks USING btree (tenant_id, assigned_agent, created_at) WHERE ((kind = 'response'::text) AND (view_column = 'inbox'::text) AND (archived_at IS NULL));
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_stage ON public.boss_tasks USING btree (tenant_id, current_stage);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_tenant_status ON public.boss_tasks USING btree (tenant_id, status);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_view_column ON public.boss_tasks USING btree (tenant_id, view_column);
...
CREATE INDEX IF NOT EXISTS idx_vasari_tasks_wo_heartbeat ON public.boss_tasks USING btree (tenant_id, assigned_agent, gate_at) WHERE ((status = 'pending'::text) AND (bucket IS NOT NULL) AND (picked_at IS NULL));
...
CREATE INDEX IF NOT EXISTS idx_voice_devices_room ON public.voice_devices USING btree (tenant_id, room);
...
CREATE INDEX IF NOT EXISTS idx_voice_devices_status ON public.voice_devices USING btree (tenant_id, status);
...
CREATE INDEX IF NOT EXISTS idx_voice_devices_tenant_id ON public.voice_devices USING btree (tenant_id);
...
CREATE INDEX IF NOT EXISTS idx_voice_transcripts_created ON public.boss_voice_transcripts USING btree (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_voice_transcripts_user ON public.boss_voice_transcripts USING btree (user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_wa_contacts_name ON public.boss_whatsapp_contacts USING btree (tenant_id, lower(display_name)) WHERE (display_name IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_wa_contacts_phone ON public.boss_whatsapp_contacts USING btree (tenant_id, phone) WHERE (phone IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_wa_contacts_synced ON public.boss_whatsapp_contacts USING btree (tenant_id, synced_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_wa_drafts_pending ON public.boss_whatsapp_drafts USING btree (tenant_id, chat_id) WHERE (status = 'pending'::text);
...
CREATE INDEX IF NOT EXISTS idx_wa_messages_thread ON public.boss_whatsapp_messages USING btree (tenant_id, chat_id, sent_at DESC);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_wa_messages_wa_id ON public.boss_whatsapp_messages USING btree (tenant_id, wa_message_id) WHERE (wa_message_id IS NOT NULL);
...
CREATE INDEX IF NOT EXISTS idx_wa_scheduled_chat ON public.boss_whatsapp_scheduled USING btree (tenant_id, chat_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_wa_scheduled_send_at ON public.boss_whatsapp_scheduled USING btree (tenant_id, send_at) WHERE ((status = 'approved'::text) AND (sent_at IS NULL));
...
CREATE INDEX IF NOT EXISTS idx_wa_threads_last ON public.boss_whatsapp_threads USING btree (tenant_id, last_message_at DESC) WHERE (archived = false);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_monitors_agent ON public.boss_whatsapp_monitors USING btree (tenant_id, agent_handle) WHERE enabled;
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_open_incident ON public.boss_incidents USING btree (kind, source) WHERE (status <> ALL (ARRAY['resolved'::text, 'escalated'::text]));
