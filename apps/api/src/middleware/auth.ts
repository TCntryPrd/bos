...
const PUBLIC_PATHS = ['/health', '/health/full', '/connectors/oauth', '/api/connectors/oauth', '/api/webhooks/', '/api/gw/check', '/api/board/rtc/guest', '/api/board/portrait/', '/api/roundtable/transcript'];
