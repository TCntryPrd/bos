...
def search_contacts(query: str, email: str = "kevin@starrpartners.ai") -> list[dict]:
    """
...
def get_all_contacts(email: str = "kevin@starrpartners.ai", max_results: int = 1000) -> list[dict]:
    """
...
def sync_to_weaviate(email: str = "kevin@starrpartners.ai", tenant: str = "kevin") -> int:
    """
